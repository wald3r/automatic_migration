          ...
          {props.images.map(image => (
            <tbody key={image.rowid}>
              <tr id='idImageRow'>
                ...
                <td id='idImageKey'>
                  <Button style={{ display: image.simulation === 1 ? 'none' : '' }} variant='primary' id='idImagesDownloadKey'  data-toggle='tooltip' data-placement='top' title='Download Key' onClick={() => handleKeyDownload(image)}><i className="fa fa-key" /></Button>
                </td>
                <td>
